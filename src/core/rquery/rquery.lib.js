...
class RQuery {
   ...
   * @returns {RQuery} The current RQuery instance foe chaining.
   */
  before(newElement) {
   ...
   * @param {function(Event): void} callback - The event listener function to execute when the selected element to clicked. The function will receive the event object as its argument.
   * @returns {RQuery} The current RQuery instance for chaining.
   */
  click(callback) {
